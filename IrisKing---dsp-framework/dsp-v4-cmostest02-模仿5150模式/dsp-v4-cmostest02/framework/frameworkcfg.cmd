...
_ISRAM = ISRAM;
_SDRAM = SDRAM;
_BUF_imgPool = BUF_imgPool;
_BUF_copyPool = BUF_copyPool;
_BUF_imgCap = BUF_imgCap;
_BUF_capFrame = BUF_capFrame;
...
_KNL_swi = KNL_swi;
_TSK_idle = TSK_idle;
_TSK_image = TSK_image;
_TSK_algorithm = TSK_algorithm;
_LNK_dataPump = LNK_dataPump;
_RTA_dispatcher = RTA_dispatcher;
_IDL_cpuLoad = IDL_cpuLoad;
_LOG_system = LOG_system;
_trace = trace;
_img_queue = img_queue;
...
-stack 0x8000
MEMORY {
   ISRAM       : origin = 0x200,       len = 0x2f300
   SDRAM       : origin = 0x8012c007,  len = 0x1f00000
}
/* MODULE CLK */
SECTIONS {
   .clk: {
...
SECTIONS {
       ...
       .buf:{} > SDRAM
        ...
        .BUF_imgPool$data: align = 0x4 {
            BUF_imgPool$databeg = .;
            .+= 614400; 
        } > SDRAM
        
        .BUF_copyPool$data: align = 0x4 {
            BUF_copyPool$databeg = .;
            .+= 616600; 
        } > SDRAM
        
        .BUF_imgCap$data: align = 0x4 {
            BUF_imgCap$databeg = .;
            .+= 614400; 
        } > SDRAM
        
        .BUF_capFrame$data: align = 0x4 {
            BUF_capFrame$databeg = .;
            .+= 1228800; 
        } > SDRAM
