...
#define VPORT_CMD_DUND_RECOVER  0x10000007  /* force the recovery of        */
                                            /* display under-run            */
#define VPORT_CMD_COVR_RECOVER  0x10000008  /* force the recovery of        */
                                            /* capture over-run             */


/* get number of pending I/O requests current in the driver queue */
#define VPORT_CMD_GET_NUM_IORQST_PENDING    0x10000009  
                                            
#define VPORT_CMD_USER          0x20000000
