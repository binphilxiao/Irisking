...
VPORTCAP_Params EMB_vCapParamsChan = {
    ...
    639,  					// fill later /*fldXStop1 */ // must subtract 1 for correct operation 
    480,  					// fill later /*fldYStop1 */ // These two parameters are used to set Field 1 stop register
    
    639,  					// fill later /*fldXStop2 */	// Must equal fldXStop1 for correct operation
