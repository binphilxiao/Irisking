...
*/
	...
	//printk("\n");
	//printk("DSPP = %x\n",ioread32(base2 + 8));
	//iowrite32(0x6, base2 + 8);
	//printk("DSPP2 = %x\n",ioread32(base2 + 8));

	//printk("GCTL ori = %x\n",ioread32(base0 + 0));
	//iowrite32(0x00092078, base0 + 0);
	//printk("GCTL after = %x\n",ioread32(base0 + 0));

	//printk("CE1 ori = %x\n",ioread32(base0 + 4));
	//iowrite32(0xF3A88E02, base0 + 4);
	//printk("CE1 after = %x\n",ioread32(base0 + 4));

	//printk("CE0 ori = %x\n",ioread32(base0 + 8));
	//iowrite32(0xFFFFFFDE, base0 + 8);
	//printk("CE0 after = %x\n",ioread32(base0 + 8));

	//printk("CE2 ori = %x\n",ioread32(base0 + 0x10));
	//iowrite32(0x22a28a22, base0 + 0x10);
	//printk("CE2 after = %x\n",ioread32(base0 + 0x10));

	//printk("CE3 ori = %x\n",ioread32(base0 + 0x14));
	//iowrite32(0x22a28a42, base0 + 0x14);
	//printk("CE3 after = %x\n",ioread32(base0 + 0x14));

	//printk("SDRAMCTL ori = %x\n",ioread32(base0 + 0x18));
	//iowrite32(0x53115000, base0 + 0x18);
	//printk("SDRAMCTL after = %x\n",ioread32(base0 + 0x18));

	//printk("SDRAMTIM ori = %x\n",ioread32(base0 + 0x1c));
	//iowrite32(0x0000081b, base0 + 0x1c);
	//printk("SDRAMTIM after = %x\n",ioread32(base0 + 0x1c));

	//printk("SDRAMEXT ori = %x\n",ioread32(base0 + 0x20));
	//iowrite32(0x000a8529, base0 + 0x20);
	//printk("SDRAMEXT after = %x\n",ioread32(base0 + 0x20));

	//printk("CE1ECCTL ori = %x\n",ioread32(base0 + 0x44));
	//iowrite32(0x00000002, base0 + 0x44);
	//printk("CE1ECCTL after = %x\n",ioread32(base0 + 0x44));

	//printk("CE0ECCTL ori = %x\n",ioread32(base0 + 0x48));
	//iowrite32(0x00000002, base0 + 0x48);
	//printk("CE0ECCTL after = %x\n",ioread32(base0 + 0x48));

	//printk("CE2ECCTL ori = %x\n",ioread32(base0 + 0x50));
	//iowrite32(0x00000002, base0 + 0x50);
	//printk("CE2ECCTL after = %x\n",ioread32(base0 + 0x50));

	//printk("CE3ECCTL ori = %x\n",ioread32(base0 + 0x54));
	//iowrite32(0x00000073, base0 + 0x54);
	//printk("CE3ECCTL after = %x\n",ioread32(base0 + 0x54));
	//=============================================================
