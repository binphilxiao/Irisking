...
/* SPICLK inactive high, slow clk, MSB, Master, 8-bit len(16-23), system/SPICLK clock ratio = 1024 */
#define  SPMODE_INIT_MASTER     0x2F7F0000
/* SPICLK inactive high, MSB, Slave, 8-bit len(16-23) */
#define  SPMODE_INIT_SLAVE      0x25700000
...
int mpc83xx_spi_bufs(struct spi_device *spi, struct spi_transfer *t)
{
	struct mpc83xx_spi *mpc83xx_spi;
	u32 word;
	...
	mpc83xx_spi_write_reg(&mpc83xx_spi->base->mode, SPMODE_INIT_SLAVE);
...
static int __init mpc83xx_spi_probe(struct platform_device *dev)
{
	...
	regval = pdata->initial_spmode | SPMODE_INIT_SLAVE;
	mpc83xx_spi_write_reg(&mpc83xx_spi->base->mode, regval);
...
EXPORT_SYMBOL(mpc83xx_spi_bufs);
