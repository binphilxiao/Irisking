...
if {[project get_assignment_value "pld" "" "" "|Wigend_In:wigend_in|wil_clk_i" "GLOBAL_SIGNAL"] !=  ""} {
  project remove_assignment "pld" "" "" "|Wigend_In:wigend_in|wil_clk_i" "GLOBAL_SIGNAL" ""
}
if {[project get_assignment_value "pld" "" "" "|Wigend_In:wigend_in|wigend_in_wil_clk" "USE_CLOCK_SETTINGS"] != ""} {
  project remove_assignment "pld" "" "" "|Wigend_In:wigend_in|wigend_in_wil_clk" "USE_CLOCK_SETTINGS" ""
}
